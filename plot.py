...
def plot_samples(problem, sde_samples, enh_samples):
    ...
    plt.scatter(enh_samples[:, problem.index_1], enh_samples[:, problem.index_2], s=0.5, c="green")
    plt.scatter(sde_samples[:, problem.index_1], sde_samples[:, problem.index_2], s=0.5, c="orange")
    plt.title(
